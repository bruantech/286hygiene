export const siteConfig = {
  ...
  siteUrl: "https://www.286hygiene.com/",
  email: "Info@286hygiene.com",
  phone: "+2349124299217",
  phoneDisplay: "+2349124299217",
  instagramUrl:
    "https://www.instagram.com/286_hygiene?igsh=MWhncnh0OXZ3aXh4cg==",
  whatsappUrl: "https://wa.me/2349124299217",
  tiktokUrl: "https://www.tiktok.com/@286_hygiene",
...
export const serviceNavItems = [
  ...
  { label: "Rug & Carpet Cleaning", href: "/services/rug-carpet-cleaning" },
...
export const footerLinkGroups = {
  Pages: primaryNavItems.map(({ label, href }) => ({ label, href })),
...
export function getPageMetadata({
  ...
  const fullTitle = title
    ...
    : `${siteConfig.name} | Professional Cleaning Services in Nigeria`;
...
export function getLocalBusinessJsonLd() {
  return {
    ...
    sameAs: [siteConfig.mapUrl, siteConfig.instagramUrl],
